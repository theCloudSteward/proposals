...
LOGGING = {
    ...
    'loggers': {
        ...
        'django': {
            'handlers': ['console'],
            'level': 'DEBUG',  # <--- Ensure "DEBUG" here
            'propagate': True,
        },
        # Your app modules (adjust "myapp" to match your code’s module name)
        '__main__': {
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': True,
        },
        # If you know the dotted path for your app code, you can also do:
