...
SECRET_KEY = 'django-insecure-4*$_=kqk@e)lt=w)!swb_3kto%j=n6og1crkqjiuzk*_@vj*b3'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / '../frontend/build'],  # React's build directory explicitly
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
