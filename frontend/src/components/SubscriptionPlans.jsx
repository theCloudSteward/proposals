          ...
          >
            <div className="mt-4 w-full text-left">
              <div className="p-3 flex items-center bg-white bg-opacity-30 shadow-md rounded-lg">
                ...
                <span className="inline-flex items-center justify-center rounded-lg bg-red-700 bg-opacity-80 ml-2 px-1 py-0.5 border border-transparent text-xs text-white transition-all shadow-sm">
                  20% Off
                </span>
              </div>
