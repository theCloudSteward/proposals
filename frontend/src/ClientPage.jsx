  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <main className="flex-grow">
        ...
        {/* 
          Using your brand color (#596E5C) as a nice backdrop for the top section.
          We lighten the text color to white for contrast. 
        */}
        ...
        <section className="bg-gray-900 text-white py-16">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-xl mx-auto">
              Select a subscription plan below, and we’ll knock 20% off all projects
              for as long as you're subscribed.
            </p>

            {/* Show a quick "20% off" banner if you want. 
                Or comment it out if you prefer a simpler design. 
            */}
            <div className="bg-[#435B45] rounded-lg shadow-lg p-6 my-10 inline-block">
              ...
              <p className="mt-2 text-sm text-white/80">20% off while subscribed!</p>
            </div>
            ...
            {isProjectOnly ? (
              ...
              <>
                <p className="mb-2 text-gray-700">
                  ...
                  {activePlan?.label || "N/A"} Subscription (20% off project)
                </p>
                <p className="mb-2 text-gray-700">
